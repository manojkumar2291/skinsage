  ...
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center px-4 py-8">
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border-t-4 border-gray-800">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  } rounded-lg focus:ring-2 focus:ring-gray-800 focus:border-transparent outline-none transition`}
                  placeholder="admin@skinsage.com"
                />
              </div>
              {errors.username && (
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-gray-800 text-white rounded-lg hover:bg-gray-900 transition font-semibold disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
